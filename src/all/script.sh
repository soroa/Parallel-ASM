...
#parallel_baseline1_OpenMP_DiagonalWise
gcc -fopenmp -std=c99 parallel_baseline1_OpenMP_DiagonalWise.c -o parallel_baseline1_OpenMP_DiagonalWise -lm

for i in `seq 1 5`;
do
     ./parallel_baseline1_OpenMP_DiagonalWise "$i.txt" "pattern.txt" 1 >> outPar1K1_Diag_OMP.txt
     ./parallel_baseline1_OpenMP_DiagonalWise "$i.txt" "pattern.txt" 2 >> outPar1K2_Diag_OMP.txt
     ./parallel_baseline1_OpenMP_DiagonalWise "$i.txt" "pattern.txt" 5 >> outPar1K5_Diag_OMP.txt
echo
done
